...
export const UR_COPY: DeepPartial<AppCopy> = {
  ...
  journey: {
    page: {
      ...
      viewFullPlanLabel: '365 دن کا مکمل منصوبہ دیکھیں',
      viewFullPlanDescription: 'آگے آنے والے سفر کا ہر دن، ہفتہ، مہینہ، اور دور، ایک ہی نظر میں۔',
    },
    plan: {
      pageTitle: '365 دن کا مکمل منصوبہ',
      pageSubtitle: 'توحید کی پہلی گواہی سے لے کر پیغام کی تکمیل تک — سفر کا ہر دن، دور، مہینے، ہفتے، اور دن کے حساب سے ترتیب دیا گیا۔',
      backToJourney: 'سفر پر واپس جائیں',
      statsDaysTotal: 'کل دن',
      statsEras: 'ادوار',
      statsWritten: 'اب تک لکھے گئے دن',
      viewPhase: 'دور',
      viewMonth: 'مہینہ',
      viewWeek: 'ہفتہ',
      viewDay: 'دن',
  ...
  settings: {
    ...
    currentHadithLanguage: 'حدیث کی موجودہ زبان',
    currentUiLanguage: 'ایپ کی موجودہ زبان',
    currentJourneyLanguage: 'سفر کی موجودہ زبان',
    defaultTranslation: 'ڈیفالٹ ترجمہ',
    defaultTafsir: 'ڈیفالٹ تفسیر',
    hadithLanguage: 'حدیث کی زبان',
    hadithLanguageDescription: 'طے کریں کہ حدیث کے معنی والا متن سفر اور حدیث صفحے میں کس زبان میں دکھے۔',
    hadithLanguageAuto: 'ایپ کی زبان کے مطابق',
    hadithLanguageEnglish: 'انگریزی',
    hadithLanguageUrdu: 'اردو',
    uiLanguage: 'ایپ کی زبان',
    uiLanguageDescription: 'انٹرفیس کی زبان منتخب کریں۔ حدیث کی زبان الگ بھی رکھ سکتے ہیں۔',
    uiLanguageAuto: 'موجودہ ایپ زبان استعمال کریں',
    uiLanguageEnglish: 'English',
    uiLanguageUrdu: 'اردو',
    journeyLanguage: 'سفر کی زبان',
    journeyLanguageDescription: 'روزانہ رہنمائی والے اسباق کس زبان میں دکھیں، اسے الگ منتخب کریں۔',
    journeyLanguageAuto: 'ایپ کی زبان کے مطابق',
    journeyLanguageEnglish: 'English',
    journeyLanguageUrdu: 'اردو',
  ...
  auth: {
    ...
    forgotPassword: {
      ...
      description: 'اپنا ای میل درج کریں اور ہم آپ کو ری سیٹ لنک بھیج دیں گے۔',
      emailPlaceholder: 'ای میل ایڈریس',
      submit: 'ری سیٹ لنک بھیجیں',
      submitting: 'بھیجا جا رہا ہے...',
      successTitle: 'اپنا ای میل چیک کریں',
      successDescription: 'اگر اس ای میل کے ساتھ اکاؤنٹ موجود ہے تو آپ کو جلد ہی پاس ورڈ ری سیٹ کا لنک مل جائے گا۔',
      backToLogin: 'لاگ ان پر واپس',
      errorGeneric: 'ری سیٹ لنک نہیں بھیجا جا سکا۔ براہ کرم بعد میں دوبارہ کوشش کریں۔',
    },
    resetPassword: {
      title: 'نیا پاس ورڈ سیٹ کریں',
      description: 'نیچے اپنا نیا پاس ورڈ درج کریں۔',
      newPasswordPlaceholder: 'نیا پاس ورڈ',
      confirmPasswordPlaceholder: 'نئے پاس ورڈ کی تصدیق',
      submit: 'پاس ورڈ ری سیٹ کریں',
      submitting: 'ری سیٹ ہو رہا ہے...',
      successTitle: 'پاس ورڈ اپڈیٹ ہو گیا',
      successDescription: 'آپ کا پاس ورڈ کامیابی سے ری سیٹ ہو گیا ہے۔',
      backToLogin: 'لاگ ان پر واپس',
      errorGeneric: 'پاس ورڈ ری سیٹ نہیں ہو سکا۔ براہ کرم دوبارہ کوشش کریں۔',
      errorMismatch: 'پاس ورڈ ایک جیسے نہیں ہیں۔',
      errorMinLength: 'پاس ورڈ کم از کم 8 حروف کا ہونا چاہیے۔',
    },
    register: {
