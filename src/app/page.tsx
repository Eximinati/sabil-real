    ...
    <div className="min-h-screen bg-[#F9F6F1]">
      ...
      <section className="min-h-screen flex flex-col">
        ...
        <div className="flex justify-between items-center px-8 py-6 max-w-[1200px] mx-auto w-full">
          <div className="flex items-center gap-2">
            <span className="text-[#1A1A1A] font-semibold text-xl">Sabil</span>
            <span className="font-arabic text-[#B7922A] text-sm" dir="rtl">سبيل</span>
          </div>
          <div className="flex items-center gap-4">
            <Link href="/login" className="text-[#6B7280] hover:text-[#1A1A1A] text-sm">Sign In</Link>
            <Link href="/register" className="bg-[#B7922A] text-white px-5 py-2 rounded-lg font-medium hover:bg-[#9A7B23]">
              Begin
            </Link>
          </div>
        </div>
        ...
        <div className="flex-1 flex flex-col items-center justify-center px-4">
          <div className="max-w-[600px] text-center">
            ...
            <p className="font-arabic text-[28px] text-center text-[#B7922A] mb-2" dir="rtl">
              {bismillah}
            </p>
            ...
            <h1 className="text-[52px] font-bold leading-tight">
              <span className="text-[#1A1A1A] block">One step a day.</span>
              <span className="text-[#B7922A] italic block">No overwhelm.</span>
            </h1>

            <p className="text-[16px] text-[#6B7280] leading-relaxed text-center mt-6 max-w-[480px] mx-auto">
            ...
            <div className="flex justify-center gap-3 mt-8">
              <Link 
                href="/register"
                className="bg-[#B7922A] text-white font-medium px-8 py-3 rounded-lg hover:bg-[#9A7B23]"
              >
                Start your journey
              </Link>
              <Link 
                href="/login"
                className="border border-[#E8E0D5] text-[#6B7280] px-8 py-3 rounded-lg hover:border-[#2D6A4F]"
              >
            ...
            {/* Preview Card */}
            <div className="max-w-[480px] mx-auto mt-12 bg-white border border-[#E8E0D5] rounded-2xl p-5">
              ...
              {previewChapters.map((chapter, idx) => (
                <div key={chapter.id}>
                  <div className="flex items-center gap-4 py-3 hover:bg-[#F9F6F1] rounded-lg px-2 -mx-2 cursor-pointer">
                    <span className="w-8 h-8 flex items-center justify-center rounded-full bg-[#B7922A]/20 text-[#B7922A] text-sm font-medium">
                      {chapter.id}
                    </span>
                    <div className="flex-1 text-left">
                      <p className="text-[#1A1A1A] text-sm font-medium">{chapter.name_simple}</p>
                  ...
                  {idx < previewChapters.length - 1 && <div className="border-t border-[#E8E0D5]/50" />}
                </div>
              ))}
              <div className="border-t border-[#E8E0D5] mt-4 pt-4">
                <Link href="/register" className="text-xs text-[#6B7280] hover:text-[#2D6A4F]">
      ...
      <section className="py-20 px-4 bg-white">
        <div className="max-w-[900px] mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {/* Card 1 */}
            <div className="bg-[#F9F6F1] border border-[#E8E0D5] rounded-2xl p-8">
              ...
              <h3 className="text-[#1A1A1A] font-semibold text-lg mb-2">Foundations first</h3>
            ...
            <div className="bg-[#F9F6F1] border border-[#E8E0D5] rounded-2xl p-8">
              ...
              <h3 className="text-[#1A1A1A] font-semibold text-lg mb-2">Reflection over scrolling</h3>
              <p className="text-[#6B7280] text-sm leading-relaxed">
            ...
            <div className="bg-[#F9F6F1] border border-[#E8E0D5] rounded-2xl p-8">
              ...
              <h3 className="text-[#1A1A1A] font-semibold text-lg mb-2">No debates, no rage</h3>
              <p className="text-[#6B7280] text-sm leading-relaxed">
      ...
      <section className="py-20 px-4 bg-[#F9F6F1]">
        <div className="max-w-[680px] mx-auto">
          <h2 className="text-[32px] font-bold text-[#1A1A1A] text-center mb-4">What your first week looks like</h2>
          <p className="text-[#6B7280] text-center mb-12">Each day is a complete lesson. No rushing.</p>

          <div className="space-y-3">
            {previewDays.map((day, idx) => (
              <div key={day.day} className="bg-white border border-[#E8E0D5] rounded-xl p-5 flex items-center gap-4 relative overflow-hidden">
                <div className="w-8 h-8 flex items-center justify-center rounded-full bg-[#B7922A] text-white font-medium text-sm">
                  {day.day}
                </div>
                <div className="flex-1">
                  <p className="text-[#1A1A1A] font-medium">{day.title}</p>
                  <span className="inline-block mt-1 px-2 py-0.5 bg-[#B7922A]/20 text-[#B7922A] text-xs rounded">
                    {day.topic}
                  </span>
                </div>
                <span className="text-[#6B7280] text-xs">~20 min</span>
                
                {idx > 0 && (
                  <div className="absolute inset-0 bg-gradient-to-r from-transparent to-[#F9F6F1]/90 flex items-center justify-end pr-4">
          ...
          <div className="text-center mt-12">
            <Link 
              href="/register"
              className="bg-[#B7922A] text-white font-medium px-8 py-3 rounded-lg inline-block hover:bg-[#9A7B23]"
            >
              Begin Day 1 Journey
            </Link>
          </div>
      ...
      <section className="py-20 px-4 bg-white">
        <div className="max-w-[600px] mx-auto text-center">
          {quran65verse && (
            <>
              <p className="font-arabic text-[28px] text-[#B7922A]" dir="rtl">{quran65verse}</p>
              <p className="text-[#6B7280] text-sm italic mt-2">And whoever fears Allah — He will make for him a way out.</p>
              <p className="text-[#6B7280]/60 text-xs">(Quran 65:3)</p>
            </>
          )}
          
          <p className="mt-8 text-[20px] text-[#1A1A1A] font-medium">
            Join thousands learning Islam, one day at a time.
          </p>
          
          <Link 
            href="/register"
            className="inline-block mt-8 bg-[#B7922A] text-white font-medium px-10 py-4 rounded-lg text-base hover:bg-[#9A7B23]"
          >
      ...
      {/* Footer */}
      <footer className="py-6 px-8 bg-[#F9F6F1] border-t border-[#E8E0D5] flex justify-between items-center">
        <p className="text-[#6B7280] text-xs">Sabil — a structured Islamic learning companion.</p>
        <p className="text-[#6B7280] text-xs">Read. Reflect. Return.</p>
      </footer>
    </div>
  );
}