    ...
    <div className="min-h-screen bg-[var(--color-bg)]">
            ...
            <div className="max-w-[480px] mx-auto mt-12 bg-[var(--color-surface)] border border-[var(--color-border)] rounded-2xl p-5">
              ...
              {previewChapters.map((chapter, idx) => (
                <div key={chapter.id}>
                  ...
                  {idx < previewChapters.length - 1 && <div className="border-t border-[var(--color-border)]/50" />}
                </div>
              ))}
      ...
      <section className="py-20 px-4 bg-[var(--color-surface)]">
        <div className="max-w-[600px] mx-auto text-center">
          {quran65verse && (
            <>
              <p className="font-arabic text-[28px] text-[var(--color-accent)]" dir="rtl">{quran65verse}</p>
