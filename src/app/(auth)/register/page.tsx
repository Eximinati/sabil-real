...
export default function RegisterPage() {
  ...
  return (
    <div>
      ...
      <p className="text-[#1A1A1A] font-medium mb-1">Create your account</p>
      <p className="text-[#6B7280] text-sm mb-6">Begin your Islamic journey</p>
      ...
      <p className="mt-6 text-center text-sm text-[#6B7280]">
        ...
        <a href="/login" className="text-[#B7922A] hover:underline">
          Sign In
        </a>
      </p>
    </div>
