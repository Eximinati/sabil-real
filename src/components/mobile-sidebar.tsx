...
const navItems = [
  { href: '/journey', label: 'Journey', icon: 'M9 20l-5.447-2.724A1 1 0 013 16.382V5.618a1 1 0 011.447-.894L9 7m0 13l6-3m-6 3V7m6 10l4.553 2.276A1 1 0 0021 18.382V7.618a1 1 0 00-.553-.894L15 4m0 13V4m0 0L9 7' },
    ...
    <>
      ...
      {isOpen && (
        <div className="fixed inset-0 z-50 md:hidden">
          ...
          />
          <aside className="absolute left-0 top-0 bottom-0 w-[240px] bg-[var(--color-primary)] text-white flex flex-col animate-fade-in">
            ...
            <div className="p-4 border-t border-white/10">
              <p className="text-white/60 text-sm truncate mb-3" title={userEmail}>{userEmail}</p>
              <SignOutButton />
            </div>
          </aside>
        </div>
