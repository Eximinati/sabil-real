  ...
  return (
    <div className="space-y-12 md:space-y-16">
      <section className="pt-2 md:pt-4">
        ...
        <h1 className="mt-3 text-[30px] font-semibold leading-[1.2] tracking-[-0.02em] text-[var(--color-text)] md:text-[44px]">
          Allah Sees You
        </h1>
        <p className="mt-4 max-w-2xl text-[16px] leading-[1.95] text-[var(--color-text-secondary)] md:text-[18px]">
        ...
        <div className="mt-10 rounded-[28px] border border-[var(--color-border)] bg-[var(--color-surface)]/85 px-6 py-7 md:px-8 md:py-9">
          ...
          <p className="mt-5 font-arabic text-right text-[30px] leading-[2.3] text-[var(--color-text)] md:text-[38px]" dir="rtl">
            مَا وَدَّعَكَ رَبُّكَ وَمَا قَلَى
          </p>
          <p className="mt-5 text-[15px] leading-[1.9] text-[var(--color-text-secondary)] md:text-[16px]">
      ...
      <section className="max-w-3xl">
        ...
        <div className="space-y-5 text-[16px] leading-[1.95] text-[var(--color-text)]">
          <p>
      ...
      <section className="rounded-[28px] border border-[var(--color-border)] bg-[var(--color-surface)]/80 px-6 py-7 md:px-8 md:py-8">
        ...
        <p className="mt-5 text-[16px] leading-[1.95] text-[var(--color-text)]">
        ...
        <p className="mt-5 text-[16px] leading-[1.95] text-[var(--color-text-secondary)]">
      ...
      <section className="rounded-[28px] border border-[var(--color-border)] bg-[var(--color-surface)]/82 px-6 py-7 md:px-8 md:py-8">
      ...
      <section className="rounded-[30px] border border-[var(--color-border)] bg-gradient-to-b from-[var(--color-surface)] to-[var(--color-bg)] px-6 py-8 md:px-9 md:py-10">
