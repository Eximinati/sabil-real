...
export function AudioPlayer() {
  const { state, toggle, seek } = useAudioPlayerContext();
          ...
          <div className="flex items-center gap-3 md:gap-4">
            ...
            <div className="flex-1 min-w-0">
              <div className="flex items-center justify-between mb-1 md:mb-2">
                ...
                {currentReciter && (
                  <p className="text-xs md:text-sm text-[var(--color-text-muted)] ml-2 flex-shrink-0 hidden sm:block">
                    {currentReciter.name}
                  </p>
                )}
              </div>
                ...
                <>
                  <div className="relative">
                    <input
                      ...
                      className="w-full h-1.5 md:h-2 bg-[var(--color-border)] rounded-full appearance-none cursor-pointer [&::-webkit-slider-thumb]:appearance-none [&::-webkit-slider-thumb]:w-3 [&::-webkit-slider-thumb]:h-3 md:[&::-webkit-slider-thumb]:w-4 md:[&::-webkit-slider-thumb]:h-4 [&::-webkit-slider-thumb]:bg-[var(--color-primary)] [&::-webkit-slider-thumb]:rounded-full [&::-webkit-slider-thumb]:cursor-pointer"
                      style={{
